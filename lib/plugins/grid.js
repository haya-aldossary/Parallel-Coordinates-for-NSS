...
(function(undefined) {
  ...
  window.grid = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      this.isAsc = true;
      this.currentSortCol = "Level";
      this.select_Id = -1;

      this.dataView = new Slick.Data.DataView();
      this.dataView.setPagingOptions({
      	pageSize: 200,
      	pageNum: 0
      ...
      this.columnpicker = new Slick.Controls.ColumnPicker(this.cols, this.grid, this.options);
      ...
      console.log(Slick.Controls.Pager);
